...
tf.compat.v1.app.flags.DEFINE_string('train_dir', '/tmp/mnist',
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    loss = tf.reduce_mean(input_tensor=tf.nn.softmax_cross_entropy_with_logits(
        labels=tf.stop_gradient(train_labels_node)))
    ...
    with tf.compat.v1.Session() as s:
        ...
        if RESTORE_MODEL:
            ...
            summary_writer = tf.compat.v1.summary.FileWriter(FLAGS.train_dir,graph_def=s.graph_def)
            print ('Initialized!')
